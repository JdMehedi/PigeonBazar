            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <a class="navbar-brand" style="font-size:16px" href="{{route('products.index')}}">
                            Products
                        </a>

                        <a class="navbar-brand" style="font-size:16px"  href="{{route('products.create')}}">
                           Upload Products
                        </a>
                        <a class="navbar-brand" style="font-size:16px"  href="{{route('settings.index')}}">
                           Settings
                         </a>
