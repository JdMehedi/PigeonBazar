            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        <h3 class="heading-title" ><?php echo e($settings->site_name); ?></h3>
                        <div class="heading-line">
                            <span class="short-line"></span>
                            <span class="long-line"></span>
                        </div>
                        <p class="heading-text"><?php echo e($settings->about); ?>
            ...
            <div class="contacts">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title"><?php echo e($settings->contact_number); ?></a>
                            <p class="sub-title"><?php echo e($settings->site_name); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title"><?php echo e($settings->contact_email); ?></a>
                            <p class="sub-title"><?php echo e($settings->site_name); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title"><?php echo e($settings->site_name); ?></a>
                            <p class="sub-title"><?php echo e($settings->address); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
</footer><?php /**PATH C:\xampp\htdocs\Pigeonbazar\resources\views/includes/footer.blade.php ENDPATH**/ ?>